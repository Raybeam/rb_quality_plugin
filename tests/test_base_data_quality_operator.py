import pytest
from plugins.base_data_quality_operator import BaseDataQualityOperator, PostgresHook, MySqlHook, HiveServer2Hook
...
def test_get_result_invalid_connection(mocker):
    with pytest.raises(ValueError):
        BaseDataQualityOperator.get_result(
