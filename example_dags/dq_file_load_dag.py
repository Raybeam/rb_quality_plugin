...
"""Task to check revenue against low & high of Monthly_Return table (test fails)"""
task_check_from_last_month = DataQualityThresholdSQLCheckOperator(
    ...
    push_conn_id="push_conn",
    check_description="test of whether the revenue is between 20% of low and high of Monthly_Return table in the last month",
    dag=dag
)
