...
{
   # Display help
   echo "This script will deploy the rb_quality_plugin to an environment, using the instructions listed in the README.md file."
   echo
   echo
   ...
   echo
   echo "Example:"
   echo -e "\t./plugins/rb_quality_plugin/deploy.sh --environment=local"
   echo
}
